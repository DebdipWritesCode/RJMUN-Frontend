...
const Landing = () => {
  ...
  return (
    <div className="flex items-center justify-center">
      <div className="bg-tertiary shadow-xl rounded-xl p-8 w-full max-w-sm flex flex-col items-center space-y-6">
        ...
        <Button
          className="w-full bg-[#1c2d27] text-tertiary text-lg py-6"
