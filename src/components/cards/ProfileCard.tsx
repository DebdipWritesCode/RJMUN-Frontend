...
const ProfileCard: React.FC<ProfileCardProps> = ({ imageSrc, heading, subheading }) => {
  return (
    <div
      className="rounded-xl bg-cover bg-center p-4 text-center relative flex justify-center text-white mb-3 w-[300px] h-[300px]"
      style={{ backgroundImage: `url('/images/ContainerBG.png')` }}
    >
      <div className="flex justify-center">
        <img src={imageSrc} alt={heading} className="max-h-72 w-auto object-contain absolute top-[-25px]" />
      </div>
