...
type SponsorFormData = z.infer<typeof schema>;
...
const SponsorForm: React.FC<SponsorFormProps> = ({ initialData, onClose }) => {
  const {
    register,
    control,
    handleSubmit,
    ...
    defaultValues: {
      ...
      type: initialData?.type || "endorsement",
    },
  });
  ...
  const onSubmit = async (data: SponsorFormData) => {
    ...
    try {
      console.log("Submitting Sponsor form with data:", data);
      if (initialData?._id) {
        await api.put(`/sponsors/${initialData._id}`, formData, {
      ...
      toast.error("Failed to submit Sponsor form");
    }
  };
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                <SelectTrigger className="bg-white/50 border-gray-200/50 focus:border-blue-500 focus:bg-white transition-all duration-200 rounded-xl">
